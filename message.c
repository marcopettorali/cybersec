...
>>>>>>> c2aa42e64d01e44a0ed4dc2339c332c99f80ef00
    int pt_byte_index = 0;
...
<<<<<<< HEAD
    ...
    if (memcmp(authInstance->nonce_server, nonce_server_rec, NONCE_32) != 0) {
        printf("Mismatch nonce_server in M_RES_PLAY_OPPONENT\n");
        return false;
    }
    if (memcmp(authInstance->nonce_client, nonce_client_rec, NONCE_32) != 0) {
...
<<<<<<< HEAD
    if (ciphertext_and_info_buf == NULL) {
        printf("Error: Unable to create ciphertext Ekas in M_INFORM_SERVER_GAME_START\n");
        return NULL;
    }
=======
...
<<<<<<< HEAD
    if (plaintext == NULL) {
        printf("Error in decryption symmetric ciphertext M_INFORM_SERVER_GAME_START\nAbort\n");
        return 0;
    }
    // extract and verify info in plaintext
...
<<<<<<< HEAD
    if (authInstance->expected_opcode < SUCCESSFUL_CLIENT_SERVER_AUTH) {
        printf("Received M_INFORM_SERVER_GAME_START but not yet authenticated client\n");
        return false;
    }
=======
...
<<<<<<< HEAD
    if (ciphertext_and_info_buf == NULL) {
        printf("Error: Unable to create ciphertext Ekas in M_INFORM_SERVER_GAME_END\n");
        return NULL;
    }
...
<<<<<<< HEAD
    if (plaintext == NULL) {
        printf("Error in decryption symmetric ciphertext M_INFORM_SERVER_GAME_END\nAbort\n");
        return 0;
    }
    // extract and verify info in plaintext
...
<<<<<<< HEAD
    if (memcmp(authInstance->nonce_client, nonce_client_rec, NONCE_32) != 0) {
        printf("Mismatch nonce_client in M_INFORM_SERVER_GAME_END\n");
        return false;
    }
    if (authInstance->expected_opcode < SUCCESSFUL_CLIENT_SERVER_AUTH) {
        printf("Received M_INFORM_SERVER_GAME_END but not yet authenticated client\n");
        return false;
    }
=======
...
Message* create_M2_INFORM_SERVER_GAME_END(AuthenticationInstance * authInstance){
    ...
    mex->payload = (unsigned char *)malloc(ciphertext_and_info_buf_size);
    if(mex->payload==NULL)
        printf("[%s]:mex->payload null! MALLOC ERROR\n",authInstance->nickname_client);
